...
return [
    ...
    'color_settings_help'       => 'These settings will be used throughout VDOT.  Users are able to override the link colors by editing their account preferences to meet their individual readability requirements.',
    ...
    'link_dark_color_help'      => 'Select a color that will provide enough contrast for people that use VDOT in dark mode.',
    'link_light_color'          => 'Link Color for Light Mode',
    'link_light_color_help'     => 'Select a color that will provide enough contrast for people that use VDOT in light mode.',
    ...
    'ldap_display_name_help'    => 'If you have a separate displayName field in your LDAP/AD, map it here and it will be used for displaying users within VDOT.',
    ...
    'ldap_activated_flag_help'  => 'This value is used to determine whether a synced user can login to VDOT. <strong>It does not affect the ability to check items in or out to them</strong>, and should be the <strong>attribute name</strong> within your AD/LDAP, <strong>not the value</strong>. <br><br>If this field is set to a field name that does not exist in your AD/LDAP, or the value in the AD/LDAP field is set to <code>0</code> or <code>false</code>, <strong>user login will be disabled</strong>. If the value in the AD/LDAP field is set to <code>1</code> or <code>true</code> or <em>any other text</em> means the user can log in. When the field is blank in your AD, we respect the <code>userAccountControl</code> attribute, which usually allows non-suspended users to log in.',
    ...
    'load_remote_help_text'		=> 'Uncheck this box if your install cannot load scripts from the outside internet. This will prevent VDOT from trying load avatars from Gravatar or other outside sources.',
    ...
    'login_remote_user_custom_logout_url_help' => 'If a url is provided here, users will get redirected to this URL after the user logs out of VDOT. This is useful to close the user sessions of your Authentication provider correctly.',
    ...
    'show_images_in_email_help'   => 'Uncheck this box if your VDOT installation is behind a VPN or closed network and users outside the network will not be able to load images served from this installation in their emails.',
    'site_name'                 => 'Site Name',
    ...
    'snipe_version'  			=> 'VDOT version',
    'support_footer'            => 'Support Footer Links ',
    'support_footer_help'       => 'Specify who sees the links to the VDOT Support info and Users Manual',
    'version_footer'            => 'Version in Footer ',
    'version_footer_help'       => 'Specify who sees the VDOT version and build number.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Link to VDOT in Emails',
    'show_url_in_emails_help_text'      => 'Uncheck this box if you do not wish to link back to your VDOT installation in your email footers. Useful if most of your users never login. ',
    'text_pt'        => 'pt',
    ...
    'label2_2d_target_help'   => 'The data that will be contained in the 2D barcode. This can link to the asset directly in VDOT or can be one of the non-linked field values. If you use the prefix above, it will be prepended to this value.',
